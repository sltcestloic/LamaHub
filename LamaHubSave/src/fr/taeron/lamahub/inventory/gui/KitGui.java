...
private static Inventory i;
	...
	public KitGui(){
		...
		i.setItem(5, new ItemBuilder(Material.POTION).data((short)16388).displayName("�9Viper").lore("Une chance sur trois de mettre poison 1 pendant 5 secondes � ton adversaire").build());
	}
