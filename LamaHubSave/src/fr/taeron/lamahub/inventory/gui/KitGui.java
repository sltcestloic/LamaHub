...
private static Inventory i;
	...
	public KitGui(){
		...
		i.setItem(7, new ItemBuilder(Material.DIAMOND_SWORD).enchant(Enchantment.DAMAGE_ALL, 1000).displayName("§9Mongole").lore("Kit pour les abrutis finis","qui ne savent pas jouer sans speed 2", "(par contre t'as moins de soup et une épée en bois,", "ça t'apprendra a pas savoir jouer)").build());
	}
