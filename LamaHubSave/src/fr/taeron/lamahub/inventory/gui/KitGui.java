...
private static Inventory i;
	...
	public KitGui(){
		...
		i.setItem(3, new ItemBuilder(Material.FIREWORK).displayName("§9Kangaroo").lore("Spawn avec une fusée qui te propulse quand tu click droit dessus.", "La poussée horizontale est doublée si tu es en sneak").build());
	}
