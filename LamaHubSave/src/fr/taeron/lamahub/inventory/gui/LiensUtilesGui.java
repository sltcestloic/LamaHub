...
public class LiensUtilesGui {
	...
	public LiensUtilesGui(){
		...
		i.setItem(6, new ItemBuilder(Material.SIGN).displayName("§6§lDiscord").data((short)3).lore("§a➔ §f Clique droit/gauche").build());
		i.setItem(6, new ItemBuilder(Material.SIGN).displayName("§6§lDeveloppeurs :3").data((short)1).lore("§a➔ §f Clique droit/gauche").build());
	}
