...
public class KitShopGui {
	...
	public KitShopGui(){
		...
		i.setItem(3, new ItemBuilder(Material.WOOD_AXE).displayName("§9Thor").lore("Un coup de thor spawn un block de netherrack"," un second coup sur le block de netherrack", "crée une explosion fatal pour les joueurs", "dans un rayon de 3 blocks", " ", "§2Prix: §63000 LamaCoins").build());
	}
