...
public class DuelInventory extends InventorySnapshot{

	public DuelInventory(LamaHub plugin) {
		super(plugin, new DuelScoreboardProvider(), new Location(Bukkit.getWorld("Hub"), 0.0, 108.0, 0.0));
	}
